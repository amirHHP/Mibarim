...
import com.mibarim.main.ui.activities.AnimatedExpandableListView.AnimatedExpandableListAdapter;
 ...
 */
public class MainExpandableAnimatedListActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.main_expandable_animated_list_activity);
...
//            holder.hint.setText(item.hint);
        ...
        public View getGroupView(int groupPosition, boolean isExpanded, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                ...
                convertView = inflater.inflate(R.layout.route_group_item, parent, false);
                holder.title = (TextView) convertView.findViewById(R.id.textTitle);
                convertView.setTag(holder);
            } else {

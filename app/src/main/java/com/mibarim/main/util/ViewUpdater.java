...
public class ViewUpdater {
     ...
     * @return image view
     */
    public BootstrapCircleThumbnail bootstrapImageView(final int childViewIndex) {
        return (BootstrapCircleThumbnail) childViews[childViewIndex];
    }
     ...
     * @return text view
     */
    public BootstrapButton setTextBootstrapButton(final int childViewIndex, final CharSequence text) {
        final BootstrapButton bootstrapButton = view(childViewIndex);
        bootstrapButton.setText(text);

...
public abstract class TypeAdapter extends BaseAdapter {
     ...
     * @return image view
     */
    protected BootstrapCircleThumbnail bootstrapImageView(final int childViewIndex) {
        return updater.bootstrapImageView(childViewIndex);
    }

    /**
     * Set text on BootstrapButton at given index
     *
     * @param childViewIndex
     * @param text
     * @return text view
     */
    protected BootstrapButton setTextBootstrapButton(final int childViewIndex, final CharSequence text) {
        return updater.setTextBootstrapButton(childViewIndex, text);
    }
}
